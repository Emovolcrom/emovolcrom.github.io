...
<body>
<header>
  <h2>Puertos del Estado - Tiempo real - Presion atmosferica</h2>
</header>
...
<section>
  <nav>
    <ul>
      ...
      <li><a class="active" href="puertos-tiempoReal-presionAtmosferica.php">Presion atmosferica</a></li>
  ...
  <article>
    <iframe width="100%" height="262px" scrolling="no" src="https://portus.puertos.es/PortusData/rtChart?station=3450&params=AirPressure&dirParams=&int=default&isRadar=false&locale=es"></iframe>
    <iframe width='100%' height='350px' scrolling="no" src='https://portus.puertos.es/index.html#/dataTablesRTWidget?stationCode=3450&variables=AIR_PRESURE&isRadar=false&latId=&lonId=&locale=es'></iframe>
  </article>
</section>

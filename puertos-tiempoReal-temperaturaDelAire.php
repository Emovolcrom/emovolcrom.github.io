...
<body>
<header>
  <h2>Puertos del Estado - Tiempo real - Temperatura del aire</h2>
</header>
...
<section>
  <nav>
    <ul>
      ...
      <li><a class="active" href="puertos-tiempoReal-temperaturaDelAire.php">Temperatura del aire</a></li>
      <li><a href="puertos-tiempoReal-viento.php">Viento</a></li>
    </ul>
  </nav>

  <article>
    <p>La boya que se utilizaba para medir la temperatura del aire está fuera de funcionamiento, se muestran los datos de la boya de Tenerife sur.</p>
          <iframe width="100%" height="262px" scrolling="no" src="https://portus.puertos.es/PortusData/rtChart?station=2446&params=AirTemp&dirParams=&int=default&isRadar=false&locale=es"></iframe>
          <iframe width='100%' height='350px' scrolling="no" src='https://portus.puertos.es/index.html#/dataTablesRTWidget?stationCode=2446&variables=AIR_TEMP&isRadar=false&latId=&lonId=&locale=es'></iframe>
  </article>
</section>

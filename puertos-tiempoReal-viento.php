...
<section>
  <nav>
    <ul>
      ...
      <li><a class="active" href="puertos-tiempoReal-viento.php">Viento</a></li>
    </ul>
  </nav>

  <article>
    <iframe width="100%" height="262px" scrolling="no" src="https://portus.puertos.es/PortusData/rtChart?station=3450&params=WindSpeed,WindSpeedMax&dirParams=WindDir,WindDirMax&int=default&isRadar=false&locale=es"></iframe>
    <iframe width='100%' height='350px' scrolling="no" src='https://portus.puertos.es/index.html#/dataTablesRTWidget?stationCode=3450&variables=WIND&isRadar=false&latId=&lonId=&locale=es'></iframe>
  </article>
</section>

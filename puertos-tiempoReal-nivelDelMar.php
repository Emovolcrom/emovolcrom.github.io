...
<body>
<header>
  <h2>Puertos del Estado - Tiempo real - Nivel del mar</h2>
</header>
...
<section>
  <nav>
    <ul>
      ...
      <li><a class="active" href="puertos-tiempoReal-nivelDelMar.php">Nivel del mar</a></li>
  ...
  <article>
    <iframe width="100%" height="262px" scrolling="no" src="https://portus.puertos.es/PortusData/rtChart?station=3450&params=SeaLevel&dirParams=&int=default&isRadar=false&locale=es"></iframe>
    <iframe width='100%' height='350px' scrolling="no" src='https://portus.puertos.es/index.html#/dataTablesRTWidget?stationCode=3450&variables=SEA_LEVEL&isRadar=false&latId=&lonId=&locale=es'></iframe>
  </article>
</section>

...
<body>
<header>
  <h2>Puertos del Estado - Tiempo real - Temperatura del agua</h2>
</header>
...
<section>
  <nav>
    <ul>
      ...
      <li><a class="active" href="puertos-tiempoReal-temperaturaDelAgua.php">Temperatura del agua</a></li>
  ...
  <article>
    <iframe width="100%" height="262px" scrolling="no" src="https://portus.puertos.es/PortusData/rtChart?station=1414&params=WaterTemp&dirParams=&int=default&isRadar=false&locale=es"></iframe>
    <iframe width='100%' height='350px' scrolling="no" src='https://portus.puertos.es/index.html#/dataTablesRTWidget?stationCode=1414&variables=WATER_TEMP&isRadar=false&latId=&lonId=&locale=es'></iframe>
  </article>
</section>
